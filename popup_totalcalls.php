...
if ($category === 'Answered Calls') {
    $sqlTotalCallsPopup = "SELECT *, DATE(call_date) AS call_date_date, TIME(call_date) AS call_date_time FROM vicidial_closer_log WHERE status NOT IN ('DROP', 'QUEUE', 'AFTHRS', 'ERI', 'TIMEOT', 'XDROP') AND call_date BETWEEN '$fromDate $fromTime' AND '$toDate $toTime'";
} elseif ($category === 'Abandoned Calls') {
    $sqlTotalCallsPopup = "SELECT *, DATE(call_date) AS call_date_date, TIME(call_date) AS call_date_time FROM vicidial_closer_log WHERE status IN ('DROP', 'AFTHRS', 'ERI', 'TIMEOT', 'XDROP') AND call_date BETWEEN '$fromDate $fromTime' AND '$toDate $toTime'";
} elseif ($category === 'Total Calls') {
    $sqlTotalCallsPopup = "SELECT *, DATE(call_date) AS call_date_date, TIME(call_date) AS call_date_time FROM vicidial_closer_log WHERE call_date BETWEEN '$fromDate $fromTime' AND '$toDate $toTime'";
} else {
