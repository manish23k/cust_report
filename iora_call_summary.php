...
if (isset($_POST['filter'])) {
    ...
    if (!empty($district_filter) && $district_filter != 'ALL') {
        $whereClause .= " WHERE district LIKE '%$district_filter%'";
    }
    ...
    $sql_district = "SELECT district, COUNT(*) AS count FROM excel_data" . $whereClause . " GROUP BY district";
} else {
    // Fetch district counts from Excel_data table
    $sql_district = "SELECT district, COUNT(*) AS count FROM excel_data GROUP BY district";
}
...
<body>
    ...
    <h1 class="mb-3" align="center">જિલ્લાવાઇઝ સમરી</h1>
</br>
    <form method="post" action="">
    <div class="form-row align-items-end">
        <div class="col-md-3 mb-3">
            <label for="type_filter">એપ્લિકેશનનો પ્રકાર પસંદ કરો:</label>
        ...
        <div class='container mt-4'>
            <h2 style='text-align: center;'>એપ્લિકેશન કૉલ સમરી રિપોર્ટ</h2>
        </div>
