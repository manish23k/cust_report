    ...
    <div class="container mt-5 text-center">
        ...
        <form method="get" class="mb-3">
            <div class="row">
                ...
                <!-- MOVED APPLYBUTTON FROM BOTTOM TO TOP -->
                </div>
            <div class="row">
        ...
        <script>
            ...
            document.getElementById('statusChart').on('plotly_click', function(data) {
                ...
                if (data.points.length > 0) {
                    ...
                    var popupURL = 'iora_ogpopup_status.php?status_id=' + encodeURIComponent(selectedStatusId) +
        ...
        <script>
            ...
            document.getElementById('totalCallsChart').on('plotly_click', function(data) {
                ...
                if (data.points.length > 0) {
                    ...
                    var popupURL = 'iora_ogpopup_totalcalls.php?category=' + encodeURIComponent(selectedCategory) +
                        '&from_date=' + encodeURIComponent(fromDate) +
                        '&to_date=' + encodeURIComponent(toDate) +
                        '&from_time=' + encodeURIComponent(fromTime) +
                        '&to_time=' + encodeURIComponent(toTime);
