...
<body>
    <div class="container mt-5 text-center">
        <h1 class="mb-3">Inbound Calls Statistics</h1>
    ...
    <div id="sectionsContainer">
        ...
        if ($dataType === 'call_status' || $dataType === 'all') {
            echo '<h2 id="callStatusTitle" style="cursor: pointer; text-decoration: underline;">Call Status Breakdown</h2>';
        ...
        if ($dataType === 'user_calls' || $dataType === 'all') {
            echo '<h2 id="userCallsTitle" style="cursor: pointer; text-decoration: underline;">User Calls Count</h2>';
        ...
        if ($dataType === 'total_calls' || $dataType === 'all') {
            echo '<h2 id="dataTypeTitle" style="cursor: pointer; text-decoration: underline;">Total Calls</h2>';
